...
groupRouter.get('/groups', logRequest, async (req, res, next) => {
  try {
...
groupRouter.get('/groups/:id', logRequest, async (req, res, next) => {
  try {
    const { id } = req.params;
...
groupRouter.delete('/groups/:id', logRequest, async (req, res, next) => {
  try {
    const { id } = req.params;
